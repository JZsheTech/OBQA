...
documents(id, collection_id, file_name, file_path, num_pages, created_at)
...
turns(id, chat_id, user_question, llm_answer_text, llm_thought_text, created_at)
...
- turn2evidence(turn_id, chat_id, evidence_no)