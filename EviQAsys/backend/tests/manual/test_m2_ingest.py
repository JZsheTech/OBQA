...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--collection-id", type=int, required=True, help="Target collection ID to ingest into.")
...
def main() -> None:
    ...
    print(f"[{datetime.utcnow()}] Starting ingestion for collection={args.collection_id}")
    ...
    try:
        document = ingestor.ingest_path(args.collection_id, args.pdf)
