...
export default function CollectionDetail() {
    ...
    const selectedPageLabel = selectedResult ? formatPageLabel(selectedResult.page_start, selectedResult.page_end) : ""
                    ...
                    <div className="card">
                        ...
                        <div className="stack">
                            <textarea
                                ...
                                placeholder="输入关键词或问题，检索 collection 内的 chunk"
                            ></textarea>
                            <div className="segmented-control">
                            ...
                            {ragLoading ? (
                                ...
                                <div className="list">
                                    {ragResults.map((item, index) => {
                                        ...
                                        return (
                                            <div key={`${chunkId}-${item.doc_id ?? "doc"}`} className="list-item rag-item">
